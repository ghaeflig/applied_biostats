...
```{r, fig.width=10, fig.height =5, fig.cap = "Boxplots of the raw data and the logarithm of the data", echo=FALSE}
...
kable(summary_table[,1:5],align='cccccc', caption = "Mean, Standard deviation and median absolute deviation of the variables.") 
kable(summary_table[,6:11],align='ccccccc')
```

## Bivariate numerical (correlations)

```{r, fig.width=5, fig.height =5, fig.cap=paste("Correlation values between each features"), echo=FALSE, message=FALSE, warning=FALSE}
#Numerical part
...
```{r, fig.width=7, fig.height =7, fig.cap="Scatter plots for every relations.", echo=FALSE}
pairs(data_log)
```
...
```{r, fig.cap = "Residual analysis", echo=FALSE}
