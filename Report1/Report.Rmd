...
Firstly, the normal QQ-plot illustrates whether our data follows a normal distribution. In this case, despite the central airlines' data, the standardized residuals are mostly aligned on a straight line. This confirms that the errors follow a normal distribution. 
